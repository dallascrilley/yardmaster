export const runHelp = [
  ...
  '  Relevant env vars: GENIE_PROVIDER, GENIE_MODEL, GENIE_PI_MODEL (default model when provider is pi), GENIE_MODE, GENIE_WORKSPACE, GENIE_TRUST, GENIE_TIMEOUT_MS, GENIE_OUTPUT',
  '',
  'Recovery tips:',
...
export const designHelp = [
  ...
  'Config and precedence:',
  '  flags > GENIE_* env vars > .genie/config.json > ~/.config/genie/config.json > defaults',
  '  Relevant env vars: GENIE_PROVIDER, GENIE_MODEL, GENIE_PI_MODEL, GENIE_MODE, GENIE_WORKSPACE, GENIE_TRUST, GENIE_TIMEOUT_MS, GENIE_OUTPUT',
  '',
  'Recovery tips:',
