...
export const providersHelp = [
  ...
  '',
  'Privacy:',
  '  Provider CLIs print the signed-in account (claude auth status returns',
  '  email, orgId, orgName). Doctor redacts identity fields, labelled identity',
  '  lines, emails, and UUIDs, and sets identityRedacted. It is a filter, not a',
  '  guarantee, so skim before pasting. Pass --show-identity to see the raw',
  '  provider output.',
  '',
  'Recovery tips:',
