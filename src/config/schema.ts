...
export const yardmasterConfigSchema = z.object({
  provider: z.object({
...
export type YardmasterConfig = z.infer<typeof yardmasterConfigSchema>

export const defaultConfig: YardmasterConfig = {
  provider: {
    default: 'claude',
...
export function mergeConfig(base: YardmasterConfig, updates: Partial<YardmasterConfig>): YardmasterConfig {
  return {
    provider: {
