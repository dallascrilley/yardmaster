...
export function toMissingProviderAttempt(providerId: ProviderId): YardmasterRunResult['timings']['attempts'][number] {
  return {
    provider: providerId,
    stage: 'availability',
    durationMs: 0,
...
export function appendPreflightFailures(params: {
  ...
  attempts: YardmasterRunResult['timings']['attempts']
